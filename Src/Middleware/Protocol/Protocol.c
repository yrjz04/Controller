...
{
	DesTempture = actual_val;
	set_computer_value(SEND_TARGET_CMD,CURVES_CH1,&DesTempture,1);
}
...
{
	HAL_UART_Transmit(&huart1, (uint8_t *)Byte, sizeof(Byte), 0xFFFFF);
}
