...
#include "uc1609.h"
#include "string.h"
#include "Hardware/Drv_Spi/Drv_Spi.h"
#include "Drv_Lcd.h"
#include "main.h"
extern SPI_HandleTypeDef hspi2;

LcdSpiTypeDef Lcd_Spi = {&hspi2, LCD_CS_GPIO_Port, LCD_CS_Pin, LCD_RES_GPIO_Port, LCD_RES_Pin, LCD_DC_GPIO_Port, LCD_DC_Pin};
//定义字库
...
{
	HAL_GPIO_WritePin(Lcd_Spi.DC_GPIO_Port, Lcd_Spi.DC_GPIO_Pin, GPIO_PIN_RESET);
	HAL_SPI_Transmit(Lcd_Spi.hspi, &cmd, 1, 200);
	HAL_GPIO_WritePin(Lcd_Spi.DC_GPIO_Port, Lcd_Spi.DC_GPIO_Pin, GPIO_PIN_SET);
}
...
void lcd_init(void)
{
	//拉低复位脚0.2秒完成复位
	HAL_Delay(200);
	HAL_GPIO_WritePin(Lcd_Spi.RST_GPIO_Port, Lcd_Spi.RST_GPIO_Pin, GPIO_PIN_SET);
	HAL_Delay(20);
