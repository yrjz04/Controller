 ...
 * @LastEditTime: 2026-01-12 16:40:11
...
void TIM_PERIOD_ELAPSED_CALLBACK_Register(TIM_PeriodElapsedCallback_Item_t *Item,char *Name);
void TIM_PERIOD_ELAPSED_CALLBACK_UnRegister(TIM_PeriodElapsedCallback_Item_t *Item,char *Name);
#endif
...
void UARTEx_RX_EVENT_CALLBACK_Register(UARTEx_RxEventCallback_Item_t *Item,char *Name);
void UARTEx_RX_EVENT_CALLBACK_UnRegister(UARTEx_RxEventCallback_Item_t *Item,char *Name);
#endif

#if GPIO_EXTI_CALLBACK_ENABLE
extern GPIO_EXTI_Callback_Item_t GPIO_EXTI_Callback_TASK[GPIO_EXTI_CALLBACK_TASK_NUM];
void GPIO_EXTI_CALLBACK_Register(GPIO_EXTI_Callback_Item_t *Item,char *Name);
void GPIO_EXTI_CALLBACK_UnRegister(GPIO_EXTI_Callback_Item_t *Item,char *Name);
#endif
